                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm">Email Opening</span>
                        </div>
                        <div className="text-right">
                          <p className="text-sm font-medium">73.2%</p>
                          <Progress value={73.2} className="w-20 h-2" />
                        </div>
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <MousePointer className="h-4 w-4 text-yellow-500" />
                          <span className="text-sm">Link Clicking</span>
                        </div>
                        <div className="text-right">
                          <p className="text-sm font-medium">32.8%</p>
                          <Progress value={32.8} className="w-20 h-2" />
                        </div>
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <AlertTriangle className="h-4 w-4 text-red-500" />
                          <span className="text-sm">Data Compromise</span>
                        </div>
                        <div className="text-right">
                          <p className="text-sm font-medium">10.6%</p>
                          <Progress value={10.6} className="w-20 h-2" />
                        </div>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="h-64 bg-gray-50 rounded-lg flex items-center justify-center border-2 border-dashed border-gray-300">
                      <div className="text-center">
                        ...
                        <p className="text-gray-600">Interactive Chart: Success Rate Trends</p>
                        <p className="text-sm text-gray-500">Shows declining vulnerability over time</p>
                      </div>
                    </div>
